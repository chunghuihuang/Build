...
BuildMachine.prototype.arduino = function (UploadPath, src, tmphex, callback){
	...
	var cmdStr = "avr-gcc " + "-DF_CPU=" + D_CPU + " -Wall -L /build/tools/avr/avr/include  -I /usr/share/arduino/hardware/arduino/cores/arduino -mmcu=" + mcu + " -o " + path.join(tmppath, output) + " " + tmpdl;
